...
//                                                             <Row gutter={[16, 24]} className='flex items-center'>
//                                                                 <Col className='gutter-row' span={24}>
//                                                                     <span className='text-[16px]'>{item.productId.productName}</span>
//                                                                 </Col>
//                                                             </Row>
//                                                         </Col>
//                                                         <Col className='gutter-row' span={24}>
...
//                                                                 <Col className='gutter-row' span={12}>
//                                                                     <div>
//                                                                           <span className='text-[16px] mr-2 line-through'>{item.productId.price.toLocaleString('vi-VN')} đ</span> <span className='text-[16px]'>{item.productId.sellingPrice.toLocaleString('vi-VN')} đ</span>
//                                                                      </div >
//                                                                 </Col>
//                                                                 <Col className='gutter-row flex justify-end' span={12}>
//                                                                     <span className='text-[16px]'>x {item.quantity}</span>
